...
function mybloger_theme_scripts()
{


    wp_enqueue_style('mybloger-fonts', mybloger_fonts_url(), array(), '1.1', 'all');
    ...
    wp_enqueue_style('hover-reveal', get_template_directory_uri() . './assets/css/hover-reveal', array(), '1.1', 'all');
    ...
    wp_enqueue_style('mybloger-main', get_template_directory_uri() . './assets/css/main.css', array(), '1.1', 'all');
    ...
    wp_enqueue_script('imagesloaded-pkgd', get_template_directory_uri() . './assets/js/imagesloaded-pkgd.js', array(), 1.1, true);
    ...
    wp_enqueue_script('mybloger-main', get_template_directory_uri() . './assets/js/main.js', array(), 1.1, true);

    if (is_singular() && comments_open() && get_option('thread_comments')) {
        wp_enqueue_script('comment-reply');
    }
}
add_action('wp_enqueue_scripts', 'mybloger_theme_scripts');
