            ...
            <div class="row align-items-center">
               <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-10">
                  <div class="header__info">
                     <ul>
                        <li>
                           <a href="mailto: <?php echo esc_url($myblogger_header_email); ?> ">
                              <span>
                              ...
                              <?php echo esc_html($myblogger_header_email); ?>
                           </a>
                        </li>
                        <li>
                           <a href="tel:<?php echo esc_url($myblogger_header_phone); ?>">
                              <span>
                              ...
                              <?php echo esc_html($myblogger_header_phone); ?>
                           </a>
                        </li>
                        <li>
                           <span>
                              ...
                              <?php echo esc_html($myblogger_header_time); ?>
                           </span>
                        </li>
                     </ul>
                  </div>
